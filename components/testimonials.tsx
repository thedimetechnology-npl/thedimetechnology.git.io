        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {visibleTestimonials.map((testimonial, index) => (
            <div
              ...
              className="relative p-8 rounded-3xl bg-slate-800/50 border border-cyan-500/20 hover:border-cyan-500/40 transition-all shadow-lg hover:shadow-cyan-500/10 hover:-translate-y-1"
            >
